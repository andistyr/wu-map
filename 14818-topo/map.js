...
clear_home = function(tag) {
  localStorage.setItem('wu_map_home_deed_14818', '');
  return show_deed_info(tag);
};
...
share_deed = function(tag, el) {
  const url = `https://andistyr.github.io/wu-map/14818-topo/#${tag}`;
...
share_coords = function(x, y, el) {
  const url = `https://andistyr.github.io/wu-map/14818-topo/#${x}_${y}`;
